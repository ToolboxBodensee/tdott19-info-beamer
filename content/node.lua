...
--   header[frame]:draw(0, 0, 1920, 580)
   ...
   bold_twc:write(xpos, 20, 'Tag der offenen Türe', 120, 1,1,1,alpha)
   ...
   '42: Vorträge ruum42  /  L: Loune  /   B: Bibliothek /  H1: Holzwerkstatt 1  /  H2: Holzwerkstatt 2  / K: Küche  /  S: Siebdruckraum  /  T: Tonstudio  /  O: Outdoor / ?: other',
       24.5, 1,1,1,alpha)
---    30, 1,1,1,alpha)
end
